...
{
    public class SystemTextJsonApiClientSerializationTest
    {
        [Fact]
        public void Serialize_ShouldSucceed()
        {
            ...
            var serialization = new SystemTextJsonApiClientSerialization();
        ...
        {
            var serialization1 = new SystemTextJsonApiClientSerialization();
            var serialization2 = new SystemTextJsonApiClientSerialization();
